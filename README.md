  ...
  <header class="site-header">
    <div class="container header-inner">
      <a href="index.html" class="logo">
        <img src="The Cozy Plate logo.jpg" alt="The Cozy Plate logo" />
      </a>
    ...
    <section class="hero" aria-labelledby="heroTitle">
      <div class="container hero-grid">
        ...
        <div class="hero-media">
          <img src="Roasted Veggie Bowl.jpg" alt="Delicious cozy food served on a plate" />
        </div>
      </div>
    </section>
    ...
    <section id="carousel" class="carousel container" aria-label="Chef's Specials">
      ...
      <div class="carousel-frame">
        ...
        <ul class="carousel-slides" id="carouselSlides">
          <li class="slide">
            <img src="Roasted Veggie Bowl.jpg" alt="Roasted Veggie Bowl" />
            <div class="slide-caption">Roasted Veggie Bowl — $200</div>
          </li>

          <li class="slide">
            <img src="mushroom-pasta.jpg" alt="Creamy Mushroom Pasta" />
            <div class="slide-caption">Creamy Mushroom Pasta — $9.00</div>
          </li>

          <li class="slide">
            <img src="pot-pie.jpg" alt="Signature Pot Pie" />
